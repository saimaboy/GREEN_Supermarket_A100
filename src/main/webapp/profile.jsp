        ...
        <div class="col-lg-8 offset-lg-2">
            <div class="card border-0 mb-4">
                <div class="card-header bg-primary text-white">
                    <h5 class="font-weight-semi-bold m-0">User Profile</h5>
                </div>
                <div class="card-body p-0">
                    <div class="media p-4">
                        <img src="img/C11.jpg" class="img-fluid rounded-circle mr-4" alt="User Avatar">
...
<div class="container-fluid pt-5">
    <div class="row px-xl-5">
        <div class="col-lg-8">
            <div class="mb-4">
                <h4 class="font-weight-semi-bold mb-4">Details</h4>
                <div class="row">
            ...
            <div class="collapse mb-4" id="shipping-address">
                ...
                <div class="row">
                    ...
                    <div class="text-center">
                        <a href="#" class="btn btn-primary">Save Data</a>
                    </div>
                </div>
            </div>
        </div>
